...
Dicho esto presentamos Betizen, la primera comunidad latinoamericana de juego online con rankings justos y auditables, basados en las votaciones de los clientes, foco en la salud de los usuarios y control de los casinos. Un proyecto que apela a crear "mejores cuidadanos del mundo de las apuestas”.
...
<div class="card bg-light mb-3">
  <div class="card-body">
    ...
    <div class="card-text">
      ...
      <br>
      Progreso&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 60% (v1.0) <a href="https://www.betizen.org/roadmap/" target="_blank" rel="nofollow"><i class="fas fa-external-link-alt"></i> Ver roadmap</a>.
    </div>
    <hr>
